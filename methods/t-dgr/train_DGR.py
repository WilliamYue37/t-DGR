...
parser.add_argument("--ckpt_folder", type=str, default=None, help='name of folder to save checkpoints and logs')
parser.add_argument('--warmup', type=int, default=50000, help='number of training steps to warmup the generator')
parser.add_argument('--dataset', type=str, required=True, help='path to dataset of expert demostrations')
